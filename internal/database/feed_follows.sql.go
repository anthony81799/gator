...
SELECT user_feed_follows.id, user_feed_follows.created_at, user_feed_follows.updated_at, user_feed_follows.user_id, user_feed_follows.feed_id, feeds.name AS feed_name, users.name AS user_name
FROM
    user_feed_follows
